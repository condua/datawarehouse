  ...
  const handleSignUp = async (e) => {
    ...
    try {
      ...
      await setDoc(docRef, {
        ...
        address: "none",
        avatar:
          "https://firebasestorage.googleapis.com/v0/b/data-warehouse-18412.appspot.com/o/images%2FLogo%20HCMUT.jpg?alt=media&token=09c0b0ae-5039-4614-a8e0-ac480c2f6376",
      });
  ...
  return (
    <div className="Register">
      <form className="form-login">
        <div className="text">{/* <h1>Đăng ký</h1> */}</div>
        <div className="form-infor">
          <p className="py-2">Tên hiển thị</p>
          <input
            type="text"
            value={displayName}
          ...
          />
          <p className="py-2">Nhập lại mật khẩu</p>
          <input
            type="password"
            value={repassword}
          ...
          <button
            className="bg-primary-blue hover:bg-blue-400 text-lg"
