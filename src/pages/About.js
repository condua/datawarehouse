      ...
      <div className="container-about">
        <div className="left-side">
          ...
          <p>
            ...
            , sứ mệnh của chúng tôi là tiếp bước cho học sinh trên hành trình
            tri thức. Bằng việc cung cấp cho học sinh các công cụ và thông tin
            cần thiết, chúng tôi giúp học sinh định hướng tìm được ngôi trường
            đại học phù hợp với nguyện vọng và năng lực học tập của mình.
          </p>
        </div>
        <img
          className="right-side"
          alt=""
          src="https://collegecost.ed.gov/wwwroot/fonts/graphic-scorecard.svg"
        />
      </div>
